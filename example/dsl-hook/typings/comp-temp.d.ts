...
declare global {
  namespace MGTMP {
    ...
    type GetValueType<T extends keyof ComponentPropType> = (nodeId: MGDSL.LayerId, nodeMap: Record<MGDSL.NodeId, MGDSL.MGNode>, componentId?: string) => {
    ...
    type SlotMatchType = RegExpString
    /**
     * 组件插槽
     * @param name 插槽名称
